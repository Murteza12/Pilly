...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "PillyModel")
...
extension AppDelegate: UNUserNotificationCenterDelegate {
    ...
    func scheduleDosageLocalNotification(date: Date ,Hour:Int,Minute:Int) {
      ...
      //  reminder.dosageIdentifier = "Dosage_Day"
        ...
        notificationContent.title = "Pilly REMINDER"
        notificationContent.body = "Take Your Pills"
        
        // Set Category Identifier
        notificationContent.categoryIdentifier = categoryIdentifire
    ...
    func scheduleNotification(notificationType: String) {
        ...
        content.body = "Notification" + notificationType
